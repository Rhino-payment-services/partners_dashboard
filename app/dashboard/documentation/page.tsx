...
{`{
  ...
  "reference": "REF123456"  // Optional
              ...
              <div className='mb-4'>
                <div className='font-semibold text-[#08163d] mb-2'>Example Phone Numbers (MNO)</div>
                <div className='text-xs text-gray-700 space-y-2 mb-3'>
                  <div><b>MTN (070 prefix):</b> <code className='bg-gray-100 px-1 rounded'>256700123456</code> → Returns "John Doe"</div>
                  <div><b>MTN (071 prefix):</b> <code className='bg-gray-100 px-1 rounded'>256710123456</code> → Returns "Jane Smith"</div>
                  <div><b>Airtel (074 prefix):</b> <code className='bg-gray-100 px-1 rounded'>256740123456</code> → Returns "Jane Smith"</div>
                  <div><b>Airtel (075 prefix):</b> <code className='bg-gray-100 px-1 rounded'>256750123456</code> → Returns "Peter Okello"</div>
                </div>
              </div>

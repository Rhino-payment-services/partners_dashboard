...
export default function TransactionStatusDoc() {
  return (
    <div className='bg-white rounded-xl shadow p-6 mb-8'>
      <h2 className='font-bold text-xl text-[#08163d] mb-2'>Check Transaction Status</h2>
      <p className='text-gray-700 text-sm mb-4'>
        Use this endpoint to check the status of a transaction by its transaction ID.
      </p>
      <div className='mb-2'>
        <span className='font-semibold text-[#08163d]'>Endpoint:</span>
        <span className='ml-2 font-mono text-xs bg-gray-100 px-2 py-1 rounded'>GET /v1/transactions/:transaction_id/status</span>
      </div>
      <div className='mb-2'>
        <span className='font-semibold text-[#08163d]'>Method:</span>
        <span className='ml-2 text-xs'>GET</span>
      </div>
      <div className='mb-2'>
...
{`Authorization: Bearer YOUR_PUBLIC_KEY`}
      ...
      <div className='mb-2'>
        ...
        <pre className='bg-gray-100 rounded p-2 text-xs font-mono overflow-x-auto mb-0'>
{`fetch('https://api.rukapay.com/v1/transactions/TXN1234567890/status', {
  method: 'GET',
  headers: {
